...
const HelperBookingHistory = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        await bookingStore.fetchHelperBookings();
      } catch (error) {
    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-base-content/60 mt-1">View and manage all your jobs</p>
        </div>
        <div className="badge badge-lg badge-primary gap-2">
          <Briefcase className="w-4 h-4" />
          {filteredBookings.length} {filteredBookings.length === 1 ? "Job" : "Jobs"}
        </div>
      </div>
      ...
      {isLoading ? (
        <div className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-base-content/60 mt-4">Loading jobs...</p>
        </div>
        ...
        <div className="card bg-base-100 shadow-lg border border-base-300">
          <div className="card-body items-center justify-center py-12">
            ...
            <p className="text-lg font-semibold text-base-content/60">
              {searchTerm || filter !== "all" ? "No jobs found" : "No jobs yet"}
            </p>
...
export default HelperBookingHistory;